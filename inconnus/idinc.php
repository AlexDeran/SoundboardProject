...
if(!$pdo){
	...
	$nominc = $pdo->prepare("SELECT SQL_CALC_FOUND_ROWS Nom, Son, source FROM inconnus ORDER BY ID DESC LIMIT {$beggin} , {$perPage}");

	$nominc->execute();

	$nomminco= $nominc->fetchAll(PDO::FETCH_ASSOC);
...
<head>
	...
	<title>Nouveaux Sons Inconnus</title>
</head>
<body>
	<?php 
...
<header class="pgtitle">	
	...
	<nav class="container-fluid">
		<div id="navbox" class="row">
			...
			<form id="searchbox2" action="searchinc.php" class="form-inline my-2 my-lg-0" method="GET">
